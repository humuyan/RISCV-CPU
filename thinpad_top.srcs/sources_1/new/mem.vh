...
`define MEM_READ_WORD {0, `MEM_READ, `MEM_WORD}
`define MEM_WRITE_BYTE {0, `MEM_WRITE, `MEM_BYTE}
`define MEM_WRITE_HALF {0, `MEM_WRITE, `MEM_HALF}
`define MEM_WRITE_WORD {0, `MEM_WRITE, `MEM_WORD}